...
enum VisualWeaponsGossip
{
	...
	VIS_GOSSIP_WHAT_ACTION      = 64646,
	VIS_GOSSIP_WHO_ACTION       = 50,
...
VisualData vData[] =
{
    { 1, VIS_GOSSIP_MAIN_MENU_ACTION, GOSSIP_ICON_TALK, 0, "Atras.." },
    { 1, 2, GOSSIP_ICON_INTERACT_1, 0, "Siguiente.." },
    { 1, 0, GOSSIP_ICON_BATTLE, 3789, "Rabiar" },
    { 1, 0, GOSSIP_ICON_BATTLE, 3854, "Poder de hechizos" },
    ...
    { 1, 0, GOSSIP_ICON_BATTLE, 2671, "Poder con hechizos Arcanos y de Fuego" },
    { 1, 0, GOSSIP_ICON_BATTLE, 2672, "Poder con hechizos de Escarcha y de las Sombras" },
    { 1, 0, GOSSIP_ICON_BATTLE, 3365, "Runa de devastacion de espadas" },
    { 1, 0, GOSSIP_ICON_BATTLE, 2673, "Mangosta" },
    { 1, 0, GOSSIP_ICON_BATTLE, 2343, "Poder de hechizos" },

    { 2, VIS_GOSSIP_MAIN_MENU_ACTION, GOSSIP_ICON_TALK, 0, "Atras.." },
    { 2, 3, GOSSIP_ICON_INTERACT_1, 0, "Siguiente.." },
    { 2, 1, GOSSIP_ICON_INTERACT_1, 0, "Anterior.." },
    { 2, 0, GOSSIP_ICON_BATTLE, 425, "Templo Oscuro" },
    { 2, 0, GOSSIP_ICON_BATTLE, 3855, "Poder de hechizos III" },
    { 2, 0, GOSSIP_ICON_BATTLE, 1894, "Escalofrio gelido" },
    { 2, 0, GOSSIP_ICON_BATTLE, 1103, "Agilidad" },
    { 2, 0, GOSSIP_ICON_BATTLE, 1898, "Robo de Vida" },
    { 2, 0, GOSSIP_ICON_BATTLE, 3345, "Vida terrestre I" },
    { 2, 0, GOSSIP_ICON_BATTLE, 1743, "Arcano" },
    { 2, 0, GOSSIP_ICON_BATTLE, 3093, "Poder de ataque contra muertos y demonios" },
    { 2, 0, GOSSIP_ICON_BATTLE, 1900, "Cruzado" },
    { 2, 0, GOSSIP_ICON_BATTLE, 3846, "Poder de hechizos II" },
    ...
    { 3, VIS_GOSSIP_MAIN_MENU_ACTION, GOSSIP_ICON_TALK, 0, "Atras.." },
    { 3, 2, GOSSIP_ICON_INTERACT_1, 0, "Anterior.." },
    { 3, 0, GOSSIP_ICON_BATTLE, 3265, "Revestimiento de armas bendito" },
    { 3, 0, GOSSIP_ICON_BATTLE, 2, "Estigma de escarcha I" },
    { 3, 0, GOSSIP_ICON_BATTLE, 3, "Lengua de fuego III" },
    { 3, 0, GOSSIP_ICON_BATTLE, 3266, "Revestimiento de armas recto" },
    { 3, 0, GOSSIP_ICON_BATTLE, 1903, "Espiritu" },
    { 3, 0, GOSSIP_ICON_BATTLE, 13, "Piedra afilada" },
...
public:
    ...
    void SetVisual(Player* player, uint32 visual_id)
    {
        ...
        if (!item)
        {
            ChatHandler(player->GetSession()).PSendSysMessage("No hay objecto equipado disponible para cambiar el efecto visual.");
            return;
        }
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action) override
    {
        ...
        switch (action)
        {
            case EQUIPMENT_SLOT_START: // Main menu
                GetMainMenu(player, creature);
                return true;
