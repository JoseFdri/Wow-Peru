...
public:
        ...
        {
		player->ADD_GOSSIP_ITEM(10, "|TInterface\\icons\\Spell_Nature_Regenerate:40:40:-18|t Restaurar vida y energia", GOSSIP_SENDER_MAIN, 1);			// Restore Health and Mana
		...
		player->ADD_GOSSIP_ITEM(10, "|TInterface\\icons\\SPELL_HOLY_BORROWEDTIME:40:40:-18|t Resetear mis cooldowns", GOSSIP_SENDER_MAIN, 3);				// Reset Cooldowns
		player->ADD_GOSSIP_ITEM(10, "|TInterface\\icons\\Achievement_BG_AB_defendflags:40:40:-18|t Resetear Combate", GOSSIP_SENDER_MAIN, 4);			// Leave Combat
		...
		//player->ADD_GOSSIP_ITEM(10, "|TInterface\\icons\\SPELL_SOUL_SHARD:40:40:-18|t Crear sould shard", GOSSIP_SENDER_MAIN, 11);				// dar soulshard brujos
	...
	bool OnGossipSelect(Player* player, Creature* /*creature*/, uint32 /*sender*/, uint32 action)
	{
		...
		case 1: // Restore HP and MP
			...
			if (player->IsInCombat())
			{
				...
				player->GetSession()->SendNotification("|cffFFFF00ASISTENTE MAGDALENA \n |cffFFFFFFVIDA Y ENERGIA restauradas con exito!");
		...
		case 3: // Reset Cooldowns
				...
				player->GetSession()->SendNotification("|cffFFFF00ASISTENTE MAGDALENA \n |cffFFFFFFCooldowns restaurados con exito!");
				player->CastSpell(player, 31726);
				break;
		...
		case 4: // Leave Combat
				player->CLOSE_GOSSIP_MENU();
				player->CombatStop();
				player->GetSession()->SendNotification("|cffFFFF00ASISTENTE MAGDALENA \n |cffFFFFFFCombate removido con exito!");
				player->CastSpell(player, 31726);
				break;
